...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT(
        ...
        _______, CUSTOM(0), CUSTOM(1), CUSTOM(2), CUSTOM(5), _______, _______, _______, _______, MO(UNKNOWN), _______, _______, RGB_HUI, RGB_MOD, KC_PSCR,
        _______, _______,  DF(MAC_BASE), _______, _______, _______, _______, _______, _______, MO(UNKNOWN), _______, _______,  CUSTOM(26), KC_PAUS,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  MO(UNKNOWN), RGB_VAI,
    ...
    [MAC_FN] = LAYOUT(
       ...
       _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_TOG, KC_END,
       _______, CUSTOM(0), CUSTOM(1), CUSTOM(2), CUSTOM(5), _______, _______, _______, _______, MO(UNKNOWN), _______, _______, RGB_HUI, RGB_MOD, KC_PSCR,
       _______, DF(WIN_BASE), _______,  _______, _______, _______, _______, _______, _______, MO(UNKNOWN), _______, _______,  CUSTOM(26), KC_PAUS,
       _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  MO(UNKNOWN), RGB_VAI,
